...
The TiDB server is stateless. It does not store data and it is for computing only. TiDB is horizontally scalable and provides a unified interface to the outside through load balancing components such as Linux Virtual Server (LVS), HAProxy, or F5.
